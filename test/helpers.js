...
describe("helper functions", function () {
  ...
  describe("css", function () {
    ...
    it("should serve correct asset even if extention is not supplied", function() {
      ...
      expect(link).to.equal(
        '<link rel="stylesheet" href="/assets/asset-6410147c9f3041fb4a91f244939d6d58.css" />'
      );
    });
  });
  ...
  describe("js", function () {
    ...
    it("should serve correct asset even if extention is not supplied", function() {
      var ctx = {};
      var instance = assets({ helperContext: ctx, paths: "test/assets/js" });
      var script = ctx.js("asset");

      expect(script).to.equal(
        '<script src="/assets/asset-ccfd345d3180e74064450512b8d1655e.js"></script>'
      );
    });
